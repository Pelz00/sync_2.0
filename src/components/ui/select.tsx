...
>(function SelectTrigger({ className, children, ...props }, ref) {
  return (
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        'border-line/15 bg-panel text-content flex h-11 w-full items-center justify-between rounded-lg border px-3 text-sm',
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDown className="text-content-muted h-4 w-4 opacity-70" />
