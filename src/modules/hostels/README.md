...
Hostel listings, detail pages, and booking flow (rent + caution + 5% verified-listing fee → Paystack escrow). Landlords manage listings via the (vendor)/landlord shell.
