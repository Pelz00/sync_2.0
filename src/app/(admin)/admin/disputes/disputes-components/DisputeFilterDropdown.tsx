...
/**
 * DisputeFilterDropdown
 * Generic dropdown for Status + Priority filters.
 * Shows checkmark on active option.
 */
export function DisputeFilterDropdown<T extends string>({
  ...
  return (
    <div ref={ref} className="relative">
      <button
        onClick={() => setOpen(v => !v)}
        className="flex items-center gap-2 bg-white border border-gray-200 rounded-xl px-4 py-2.5 text-sm font-semibold text-gray-700 hover:border-gray-300 hover:bg-gray-50 transition-colors whitespace-nowrap"
      >
        {value}
