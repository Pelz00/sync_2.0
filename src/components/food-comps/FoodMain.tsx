...
// import ForYouSection from '@/components/food-comps/ForYouSection'
// import PromoBanner from '@/components/food-comps/PromoBanner'
...
// Curated "for you" row — reuses existing food images, no new assets needed
const forYouItems = [
    { slug: 'mama-puta-tanke', image: JollofOne, label: 'Jollof Bargains' },
    { slug: 'burger-king', image: BurgerOne, label: 'Burger Deals' },
    { slug: 'krafties-kitchendry', image: PastaOne, label: 'Pasta Corner' },
    { slug: 'chop-life', image: SmallChopsOne, label: 'Small Chops' },
]
...
export default function FoodMain() {
    return (
        <section className="flex flex-col gap-3">
            ...
            {/* <ForYouSection userName="Abdulmuiz" items={forYouItems} /> */}

            {/* Promo banner */}
            {/* <PromoBanner
                title="Up to 40% off, No Dull Am"
                subtitle="Save Big with Coke Pairings"
                image={PremiumOne}
            /> */}
